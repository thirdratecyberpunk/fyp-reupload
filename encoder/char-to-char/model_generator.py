'''Generates the model, encoder model and decoder model for the LSTM sequence to sequence example.'''
...
parser = argparse.ArgumentParser(description='Generates models from a .')
...
parser.add_argument('--model_output_name', default='models/model_s2s' + str(currentdatetime) + '.h5')
parser.add_argument('--encoder_model_output_name', default='models/encoder_model_s2s' + str(currentdatetime) + '.h5')
parser.add_argument('--decoder_model_output_name', default='models/decoder_model_s2s' + str(currentdatetime) + '.h5')
